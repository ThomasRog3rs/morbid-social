...
function ButtonGroupExample(): JSX.Element {
  return (
    <Button.Group>
      <Button color="gray">
        <HiUserCircle className="w-4 h-4 mr-3" /> Profile
      </Button>
      <Button color="gray">
        <HiAdjustments className="w-4 h-4 mr-3" /> Settings
      </Button>
      <Button color="gray">
        <HiCloudDownload className="w-4 h-4 mr-3" /> Messages
      </Button>
    </Button.Group>
  );
}
    ...
    <Navbar fluid rounded>
      <Navbar.Brand href="https://flowbite.com/">
        <Image
          ...
          width="32"
        />
        <span className="self-center pl-3 text-xl font-semibold whitespace-nowrap dark:text-white">
          Flowbite
        </span>
      </Navbar.Brand>
    ...
    <Timeline>
      <Timeline.Item>
        ...
        <Timeline.Content>
          ...
          <Button color="gray">
            Learn More
            <HiArrowNarrowRight className="w-3 h-3 ml-2" />
          </Button>
        </Timeline.Content>
      </Timeline.Item>
      <Timeline.Item>
